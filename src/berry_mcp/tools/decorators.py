...
import inspect
import logging
from typing import Callable, Any, Dict, Optional, get_type_hints, Union, List
...
def tool(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        logger.debug(f"Tool decorated: {tool_name} ({'async' if inspect.iscoroutinefunction(func) else 'sync'})")
...
def _generate_parameters_schema(signature: inspect.Signature, type_hints: Dict[str, Any]) -> Dict[str, Any]:

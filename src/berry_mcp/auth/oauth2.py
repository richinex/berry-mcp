...
class OAuth2Manager:
    ...
    def build_authorization_url(self, state: Optional[str] = None) -> tuple[str, Optional[str]]:
...
class QuickOAuthFlow:
    ...
    def __init__(self, oauth_manager: OAuth2Manager, callback_port: int = 8080) -> None:
        ...
        self._result: Optional[TokenInfo] = None
    ...
    async def _start_callback_server(self, state: str, code_verifier: Optional[str]) -> None:

...
class AuthenticationMiddleware:
    ...
    async def authenticate_request(self, request: Any) -> Optional[TokenInfo]:
    ...
    async def _extract_token(self, request: Any) -> Optional[str]:
...
class TokenStorage:
    ...
    async def retrieve_token(self, key: str) -> Optional[TokenInfo]:

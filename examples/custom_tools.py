...
def count_words(text: str, include_stats: bool = False) -> Union[int, Dict[str, int]]:
    """
...
def validate_json(json_string: str, pretty_print: bool = True) -> Union[str, Dict[str, str]]:
    """
...
def find_replace_text(
    ...
    if not case_sensitive:
        ...
        if max_replacements:
            result_text = re.sub(pattern, replace, text, count=max_replacements, flags=re.IGNORECASE)
        else:
